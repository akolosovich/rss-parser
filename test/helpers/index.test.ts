...
describe('isFunction', () => {
    ...
    it('false', () => {
        [
            ...
            null,
            NaN
        ].forEach(fn => expect(isFunction(fn)).toBeFalsy());
    });
});
...
describe('isArray', () => {
    ...
    it('false', () => {
        [
            ...
            function () { },
            new Function(),
        ].forEach(fn => expect(isArray(fn)).toBeFalsy());
    });
});
...
describe('isString', () => {
    it('true', () => {
        [
            '',
            new String(),
        ].forEach(fn => expect(isString(fn)).toBeTruthy());
    });
    it('false', () => {
        [
            {},
            ...
            new Function(),
            String,
        ].forEach(fn => expect(isString(fn)).toBeFalsy());
    });
});
